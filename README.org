...
Why is "G.P.E":
- G:General :: The operation with all the integrated facilities is generalised.
- P:Pure :: The entire platform is driven by the pure Turing programming
  language, elisp.
- E:Extensible :: This interactive platform is extensible for whatever you want
  to, even *make coffee* with it. 
