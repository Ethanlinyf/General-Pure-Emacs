...
Why is "G.P.E":
- G :: The operation with all the integrated facilities are generalise.
- P :: The entire platform is driven by the pure Turing programming
  language, elisp.
- E :: This interactive platform is extensible for whatever you want
