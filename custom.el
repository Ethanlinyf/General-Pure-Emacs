(custom-set-variables
 ...
 '(package-selected-packages
   '(org-superstar-mode lin abbrev all-the-icons-completion-mode zotxt window-numbering which-key vertico valign use-package undo-tree treemacs-tab-bar treemacs-projectile treemacs-persp treemacs-magit treemacs-all-the-icons rainbow-delimiters pyvenv popwin pdf-tools pangu-spacing page-break-lines osx-lib org-superstar org-roam-ui org-roam-bibtex org-ql org-noter org-download orderless ns-auto-titlebar multi-term minions markdown-mode marginalia lua-mode latex-preview-pane keycast hungry-delete htmlize good-scroll gnu-elpa-keyring-update flycheck f3 exec-path-from-shell epc embark-consult ef-themes doom-themes doom-modeline diredfl dired-git-info diminish dashboard ctrlf counsel-projectile corfu-doc company-auctex cdlatex cape all-the-icons-ibuffer all-the-icons-dired all-the-icons-completion))
